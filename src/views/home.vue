<template>
  <div class="home-container">
    ...
    <img alt="image" src="/curved6-1500h.jpg" class="home-image04" />
    ...
    <section class="home-container05">
      <div class="home-container06">
        <h1 class="home-text07 HeadingOne">
          <span class="home-text08">From nothing to something</span>
        </h1>
      ...
      <div class="home-container07">
        <div class="home-container08">
          <img alt="image" src="/image-desk-1100w.jpg" class="home-image05" />
          <span class="home-text11 Small">
            ...
            <br />
            <span class="home-text14">-NOAA</span>
          </span>
        ...
        <div class="home-container10">
          <img alt="image" src="/image-sunrise-500w.jpg" class="home-image07" />
    ...
    <section class="home-testimonials">
      <div class="home-container12">
        <div class="home-container13">
          <div class="home-container14">
            <h2 class="home-text25 HeadingOne">Work with us</h2>
            <p class="home-text26 Lead">
              <span class="home-text27">
                Whatever your qualification is - we got you!
              </span>
            </p>
            <p class="home-text28 Body">
            ...
            <p class="home-text30">Mark Jojansen</p>
            <p class="home-text31 Small">Project manager, Atlassian</p>
            <div class="home-container15">
              <img alt="image" src="/team-4-200h.jpg" class="home-image08" />
              <div class="home-container16"></div>
              <img alt="image" src="/team-3-200h.jpg" class="home-image09" />
              <div class="home-container17"></div>
              <img alt="image" src="/team-2-200h.jpg" class="home-image10" />
            </div>
          </div>
        </div>
          ...
          <div class="home-container18">
            <div class="home-container19">
              <div class="home-container20">
                <img alt="image" src="/logo-asana.svg" class="home-image11" />
              </div>
              <div class="home-container21">
                <img alt="image" src="/logo-slack.svg" class="home-image12" />
              </div>
            ...
            <div class="home-container23">
              <div class="home-container24">
                <img alt="image" src="/logo-shopify.svg" class="home-image14" />
              </div>
              ...
              <div class="home-container26">
                <img alt="image" src="/logo-invision.svg" class="home-image16" />
              </div>
            </div>
            <div class="home-container27">
              <div class="home-container28">
                <img alt="image" src="/logo-attlasian.svg" class="home-image17" />
              </div>
              <div class="home-container29">
                <img alt="image" src="/logo-weave.svg" class="home-image18" />
              </div>
            </div>
          </div>
        </div>
      ...
      <img alt="image" src="/waves-white.svg" class="home-image19" />
    ...
    <section class="home-contaier">
      <div class="home-container30">
        ...
        <h2 class="home-text32 HeadingTwo">
          <span class="home-text33">Beware The Components</span>
        </h2>
        <h3 class="home-text34 HeadingTwo">
          <span class="home-text35">How To Handle Them</span>
          <br />
        </h3>
      ...
      <div class="home-container32">
        <div class="home-container33">
          ...
          <div class="home-container35">
            ...
            <h1 class="home-text38 HeadingOne">Search and Discover!</h1>
      ...
      <div class="home-container37">
        ...
        <div class="home-container39">
          ...
          <div class="home-container41">
            ...
            <h1 class="home-text42 HeadingOne">Talk and Meet!</h1>
...
export default {
  ...
  metaInfo: {
    title: 'Infinite Imagine',
    meta: [
      {
        property: 'og:title',
        content: 'Infinite Imagine',
      },
    ],
  },
}
