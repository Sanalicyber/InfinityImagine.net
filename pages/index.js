  ...
  return (
    <>
      <div className="home-container">
        <Head>
          <title>Infinite Imagine</title>
          <meta property="og:title" content="Infinite Imagine" />
        </Head>
        <Header></Header>
          ...
          <div className="home-container12">
            <div className="home-container13">
              <div className="home-container14">
                <h2 className="home-text25 HeadingOne">Work with us</h2>
                <p className="home-text26 Lead">
                  <span className="home-text27">
                    Whatever your qualification is - we got you!
                  </span>
                </p>
                <p className="home-text28 Body">
                ...
                <p className="home-text30">Mark Jojansen</p>
                <p className="home-text31 Small">Project manager, Atlassian</p>
        ...
        <section className="home-contaier">
          <div className="home-container30">
            ...
            <h2 className="home-text32 HeadingTwo">
              <span className="home-text33">Beware The Components</span>
            </h2>
            <h3 className="home-text34 HeadingTwo">
              <span className="home-text35">How To Handle Them</span>
              <br></br>
            </h3>
          ...
          <div className="home-container32">
            <div className="home-container33">
              ...
              <div className="home-container35">
                ...
                <h1 className="home-text38 HeadingOne">Search and Discover!</h1>
          ...
          <div className="home-container37">
            ...
            <div className="home-container39">
              ...
              <div className="home-container41">
                ...
                <h1 className="home-text42 HeadingOne">Talk and Meet!</h1>
